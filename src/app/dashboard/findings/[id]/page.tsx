          ...
          <div>
            ...
            >
              ...
              {finding.aiAuthorshipConfidence !== null && (
                <Badge
                  variant={finding.aiAuthorshipConfidence > 70 ? "ai" : "human"}
                >
            ...
            <p className="text-body" style={{ margin: 0 }}>
              Repository:{" "}
              <Link
                href={`/dashboard/repos/${finding.pullRequest.repositoryId}`}
                style={{ color: "var(--color-primary)" }}
              >
                {finding.pullRequest.repository.name}
              </Link>
            </p>
          </div>
          <div
        ...
        >
          ...
          <section className="panel" style={{ overflow: "hidden" }}>
            ...
            <div className="panel-body">
              ...
              >
                AI analysis evaluated this pull request with a depth score of{" "}
                {finding.reviewDepthScore}. This finding was flagged for manual
                review based on the repository's criticality policies.
              </p>
              {finding.aiAuthorshipConfidence !== null && (
                <div
                  style={{
                ...
                >
                  ...
                  >
                    AI Assesment Rationale
                  </strong>
                  <p className="text-small" style={{ margin: 0 }}>
                    The orchestrator determined this code was likely{" "}
                    {finding.aiAuthorshipConfidence > 70
                      ? "AI generated"
                      : "human written"}{" "}
                    with a confidence score of {finding.aiAuthorshipConfidence}
                    /100.
                  </p>
                </div>
              )}
