...
export default async function SettingsPage() {
  ...
  const policy = await CriticalityService.getPolicyForRepository(
    membership.organizationId,
    "fallback_id_never_used",
  );
    ...
    <div>
      <div style={{ marginBottom: "var(--space-8)" }}>
        ...
        <p className="text-muted">
          Manage your organization's compliance and risk policies.
        </p>
      </div>
      ...
      <section className="panel" style={{ overflow: "hidden" }}>
        ...
        <div className="panel-body">
          <p className="text-muted" style={{ marginBottom: "var(--space-6)" }}>
            Define keywords or paths that indicate business-critical code (e.g.,
            auth, payments). Pull Requests touching these files will be flagged
            as Critical Findings.
          </p>

          <form
            action={updateCriticalityPolicyAction}
            style={{
              display: "flex",
